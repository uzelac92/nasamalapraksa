app.factory('webservice', function ($http) {
    ...
    obj.putEmail = function (data) {
        ...
        return $http.post('https://www.nasamalapraksa.com/api/subscribe/subscribe.php',data)
    }
    obj.putPost = function (data) {
        $http.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded; charset=UTF-8';
        return $http.post('https://www.nasamalapraksa.com/api/post/create.php',data)
    }
    obj.getPost = function (id) {
        return $http.get('https://www.nasamalapraksa.com/api/post/read_one.php?id='+id);
    }
    obj.getPosts = function () {
        return $http.get('https://www.nasamalapraksa.com/api/post/read.php');
    }
    obj.putQuestion = function (data) {
        $http.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded; charset=UTF-8';
        return $http.post('https://www.nasamalapraksa.com/api/question/create.php',data)
    }
    obj.getQuestions = function () {
        return $http.get('https://www.nasamalapraksa.com/api/question/read.php');
    }
    obj.editQuestion = function (data) {
        $http.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded; charset=UTF-8';
        return $http.post('https://www.nasamalapraksa.com/api/question/update.php',data);
    }
    ...
    obj.putComment = function (data) {
        $http.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded; charset=UTF-8';
        return $http.post('https://www.nasamalapraksa.com/api/comment/parrent.php',data)
    }
    obj.getComments = function (id) {
        return $http.get('https://www.nasamalapraksa.com/api/comment/read_all.php?id='+id);
    }
    obj.putSubcomment = function (data) {
        $http.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded; charset=UTF-8';
        return $http.post('https://www.nasamalapraksa.com/api/comment/child.php',data)
    }
